                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                <a href="{{ route('edit.user', ['id'=>$item->id]) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                    <i class="zmdi zmdi-edit"></i>
                                </a>
                                <a href="{{ route('delete.user', ['id'=>$item->id]) }}" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
